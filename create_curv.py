...
nib.freesurfer.io.write_morph_data('prf/rh.benson14_eccentricity', mat_contents['rh_eccentricity'])
...
nib.freesurfer.io.write_morph_data('prf/rh.benson14_gain', mat_contents['rh_gain'])
...
nib.freesurfer.io.write_morph_data('prf/rh.benson14_meanvol', mat_contents['rh_meanvol'])
...
nib.freesurfer.io.write_morph_data('prf/rh.benson14_r2', mat_contents['rh_r2'])
...
nib.freesurfer.io.write_morph_data('prf/rh.benson14_rfWidth', mat_contents['rh_rfWidth'])
