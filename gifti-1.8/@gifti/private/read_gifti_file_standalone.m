...
%fid = fopen('/N/dc2/scratch/davhunt/workflows/5d43890603480e00281e681c/5d43890603480e00281e681d/5ceca72b059f7a0036ff37c5/tfMRI_RETCCW_7T_AP/tfMRI_RETCCW_7T_AP_Atlas_MSMAll_hp2000_clean.dtseries.nii','rt');
%xmlstr = fread(fid,'*char')';
%fclose(fid);
t = xml_parser(xmlstr);

%try
%    fid = fopen('/N/dc2/scratch/davhunt/workflows/5d43890603480e00281e681c/5d43890603480e00281e681d/5ceca72b059f7a0036ff37c5/tfMRI_RETCCW_7T_AP/tfMRI_RETCCW_7T_AP_Atlas_hp2000_clean.dtseries.nii','rt');
%    xmlstr = fread(fid,'*char')';
%    fclose(fid);
%    t = xml_parser(xmlstr);
%catch
